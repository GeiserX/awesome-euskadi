...
- URL del repositorio
- URL del servicio/API/institución vasca a la que da soporte (p.ej. euskadi.eus, ehu.eus, eustat.eus)
Elimina esta sección si no aplica.
-->

| Proyecto | Servicio/Institución vasca |
|----------|----------------------------|
...
- URL del repositorio
- Motivo (archivado, no funcional, reemplazado, no específico de Euskadi, etc.)
Elimina esta sección si no aplica.
-->
