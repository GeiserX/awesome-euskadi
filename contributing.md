...
- El proyecto debe **dar soporte específico a Euskadi** o incluir funcionalidades relevantes para usuarios en esta comunidad autónoma.
...
5. **Incluye en la descripción de la PR la URL del servicio, API o institución vasca** a la que el software da soporte (p.ej. euskadi.eus, ehu.eus, eustat.eus). Esto ayuda a verificar que el proyecto es relevante para Euskadi.
