...
Un repositorio se incluye porque interactúa con instituciones, servicios, infraestructura, normativas o datos propios de Euskadi. No basta con que el autor sea de Euskadi o resida aquí. Un framework genérico creado por un developer de Euskadi no pertenece a esta lista. Un cliente para una API de servicios de Euskadi sí.
